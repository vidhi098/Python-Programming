...
# Add two numbers
Add: float = float(num1) + float(num2)
# Subtract two numbers
minimum: float = float(num1) - float(num2)
...
print('The subtraction of {0} and {1} is {2}'.format(num1, num2, minimum))
...
print(
    a == b)  # This operator(==)returns True if both the operands are equal i.e. if both the left and the right
# operand are equal to each other.
...
# Write a program for logical operator (and, or , not)
Num1 = True
num2 = False
print('num1 and num2 is ', num1 and num2)
print('num1 or num2 is', num1 or num2)
print('not num1 is', not num1)
